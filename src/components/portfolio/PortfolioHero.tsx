  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 text-center max-w-4xl">
        ...
        <div className="w-24 h-1 mx-auto mb-8 bg-brand-primary"></div>

        <p className="text-lg md:text-xl text-ui-text-secondary max-w-3xl mx-auto leading-relaxed mb-12">
          Creating spaces that inspire and transform. Specialized in residential, commercial, and
          interior design projects that blend functionality with aesthetic excellence.
        </p>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-ui-text-muted">
          <path
            d="M7 13l3 3 7-7"
            stroke="currentColor"
            strokeWidth="2"
