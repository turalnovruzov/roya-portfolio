...
export function ResumeSection() {
  return (
    <section id="resume" aria-label="About & Education" className="py-20 bg-ui-background">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-light mb-4 text-ui-text-primary">About</h2>
          <div className="w-16 h-1 mx-auto bg-brand-primary"></div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-ui-text-secondary leading-relaxed mb-6">
              With a passion for creating spaces that seamlessly blend form and function, I
              specialize in architectural design that responds to both environmental context and
              human experience. My work spans residential, commercial, and interior design projects,
              each approached with careful attention to sustainability, innovation, and cultural
              relevance.
            </p>
            <p className="text-ui-text-secondary leading-relaxed">
              Every project begins with understanding the unique story of the site and the people
              who will inhabit it. This human-centered approach ensures that each design solution is
              not only beautiful but meaningful and enduring.
            </p>
          </div>
