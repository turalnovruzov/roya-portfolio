...
export interface Project {
  ...
  /**
   * Main project image displayed in portfolio grid
   */
  coverImage: number | Media;
  /**
   * Additional project images displayed in project detail page
   */
  gallery?:
    | {
        image: number | Media;
  ...
  /**
   * When this project should be published and visible to visitors
   */
